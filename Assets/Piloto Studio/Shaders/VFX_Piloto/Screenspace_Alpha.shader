	...
	SubShader
	{
		...
		Pass
		{
					...
					)
			{
				...
				float2 texCoord81 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float4 texCoord162 = packedInput.ase_texcoord1;
				texCoord162.xy = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float4 temp_output_102_0 = ( ( packedInput.ase_color * float4( desaturateVar158 , 0.0 ) * ( texCoord162.z + 1.0 ) * MultiplyNoise92 ) + AdditiveNoise91 );
				
				float4 texCoord60 = packedInput.ase_texcoord1;
				texCoord60.xy = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float2 texCoord43 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				...
				surfaceDescription.Color = temp_output_102_0.rgb;
				surfaceDescription.Emission = temp_output_102_0.rgb;
				surfaceDescription.Alpha = ( packedInput.ase_color.a * saturate( saturate( ( temp_output_3_0_g51 / fwidth( temp_output_3_0_g51 ) ) ) ) * AlphaOverride49 );
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput  ) : SV_Target
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float2 texCoord81 = packedInput.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner80 = ( 1.0 * _Time.y * _DetailNoisePanning + texCoord81);
				float4 tex2DNode79 = tex2D( _DetailNoise, panner80 );
				float4 break17_g63 = tex2DNode79;
				float4 appendResult18_g63 = (float4(break17_g63.x , break17_g63.y , break17_g63.z , break17_g63.w));
				...
				float desaturateDot158 = dot( desaturateInitialColor158, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar158 = lerp( desaturateInitialColor158, desaturateDot158.xxx, _Desaturate );
				float4 texCoord162 = packedInput.ase_texcoord2;
				texCoord162.xy = packedInput.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float4 break17_g62 = tex2DNode79;
				float4 appendResult18_g62 = (float4(break17_g62.x , break17_g62.y , break17_g62.z , break17_g62.w));
				float4 clampResult19_g62 = clamp( ( appendResult18_g62 * _DetailMultiplyChannel ) , float4( 0,0,0,0 ) , float4( 1,1,1,1 ) );
				float4 break2_g62 = clampResult19_g62;
				...
				float2 texCoord43 = packedInput.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner44 = ( 1.0 * _Time.y * _AlphaOverridePanning + texCoord43);
				float4 tex2DNode45 = tex2D( _AlphaOverride, panner44 );
				float4 break2_g50 = ( tex2DNode45 * _AlphaOverrideChannel );
				float AlphaOverride49 = saturate( ( break2_g50.x + break2_g50.y + break2_g50.z + break2_g50.w ) );
		...
		Pass
		{
					...
					)
			{
				...
				BuiltinData builtinData;
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float4 texCoord60 = packedInput.ase_texcoord;
				texCoord60.xy = packedInput.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 texCoord43 = packedInput.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner44 = ( 1.0 * _Time.y * _AlphaOverridePanning + texCoord43);
				float4 tex2DNode45 = tex2D( _AlphaOverride, panner44 );
				float4 break2_g50 = ( tex2DNode45 * _AlphaOverrideChannel );
				float AlphaOverride49 = saturate( ( break2_g50.x + break2_g50.y + break2_g50.z + break2_g50.w ) );
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;127;787.0098,-573.7703;Float;False;True;-1;2;Rendering.HighDefinition.LitShaderGraphGUI;0;13;Piloto Studio/Screenspace Alpha;7f5cb9c3ea6481f469fdd856555439ef;True;Forward Unlit;0;0;Forward Unlit;9;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=-250;True;5;True;8;d3d11;metal;vulkan;xboxone;xboxseries;playstation;ps5;switch;0;True;True;1;5;True;_SrcBlend;0;True;_DstBlend;1;0;True;_AlphaSrcBlend;0;True;_AlphaDstBlend;False;False;False;False;False;False;False;False;False;False;False;True;True;0;True;_TransparentSortPriority;False;False;False;True;True;True;True;True;0;True;_ColorMaskTransparentVel;False;False;False;False;True;True;False;0;True;_StencilRef;255;False;;255;True;_StencilWriteMask;0;False;;0;False;;0;False;;0;False;;7;False;;1;False;;1;False;;1;False;;True;True;2;False;_ZTestTransparent;True;3;False;_ZTestTransparent;False;True;1;LightMode=ForwardOnly;False;False;0;Hidden/InternalErrorShader;0;0;Standard;30;Surface Type;1;0;  Rendering Pass ;0;0;  Rendering Pass;0;0;  Blending Mode;0;0;  Receive Fog;0;0;  Distortion;0;0;    Distortion Mode;0;0;    Distortion Only;1;0;  Depth Write;0;0;  Cull Mode;0;0;  Depth Test;4;0;Double-Sided;0;0;Alpha Clipping;0;0;Receive Decals;1;0;Motion Vectors;0;0;  Add Precomputed Velocity;0;0;Shadow Matte;0;0;Cast Shadows;0;0;GPU Instancing;1;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position,InvertActionOnDeselection;1;0;LOD CrossFade;0;0;0;8;True;False;True;True;True;False;False;True;False;;False;0
...
WireConnection;127;2;40;0
ASEEND*/
//CHKSM=BCB5D2F702E1641061CD5F179F586DC45BE34D50